...
read -p "3. Enter your DuckDNS Token: " DUCK_TOKEN
read -p "4. Enter your 2-letter Country Code (e.g., US, UK, DE): " COUNTRY_CODE
echo ""
...
scp "root@YOUR_IP:/root/*.sh" /home/local_user/target_folder/
...
Invert Logic: Because Gemini exports purchases as positive numbers, we MUST check the "Invert Amounts" box on the final review screen so purchases become negative (money leaving).
