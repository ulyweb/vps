Your Hostinger Self-Hosted VPS ArchitectureBelow is the visual map of how your server currently operates. It shows how traffic flows from the outside internet, through your security layers, into your proxy, and finally to your individual Docker containers.(Note: Most modern markdown viewers support Mermaid. If you copy/paste this code block below into a Mermaid Live Editor or GitHub, it will instantly generate the visual diagram!)graph TD
    %% Define Styling
